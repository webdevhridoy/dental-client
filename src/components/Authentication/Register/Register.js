                ...
                <div className="bg-blue-50">
                    <div className="px-6 md:py-12 py-9 2xl:mx-auto 2xl:container md:flex items-center justify-center">
                        ...
                        <div className="bg-white shadow-lg rounded xl:w-1/3 lg:w-5/12 md:w-1/2 w-full lg:px-10 sm:px-6 sm:py-10 px-2 py-6">
                            ...
                            <button onClick={handleGoogle} aria-labelledby='Continue with google' type="button" className="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 p-3 border rounded-lg border-gray-700 flex items-center w-full mt-10 hover:bg-gray-100">
                            ...
                            <button onClick={handleGithub} aria-label="Continue with github" type="button" className="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 p-3 border rounded-lg border-gray-700 flex items-center w-full mt-4 hover:bg-gray-100">
                            ...
                            <div>
                                <form onSubmit={handleRegister}>
                                    ...
                                    <input id='password' type="password" name="password" placeholder="enter password" className="bg-gray-200 border rounded text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
                                </div> */}
                        ...
                        <div className="xl:w-1/3 md:w-1/2 lg:ml-16 ml-8 md:mt-0 mt-6">
                            ...
                            <div className="flex items-start mt-8">
                                ...
                                <p className="sm:text-2xl text-xl leading-7 text-gray-600 pl-2.5">Excellent doctor!!!Very thorough and caring. I'm terribly afraid of the dentist and she's very sensitive to that and goes the extra mile to make you feel comfortable. Love her!
                                </p>
                            </div>
                            <div className="flex items-center pl-8 mt-10">
                                <div className="w-8 h-8">
                                    <img src="https://i.ibb.co/xLtZCRT/Mask-Group.png" alt='profile-pic' className="w-full h-full" />
                                </div>
                                <div className="ml-2">
                                    <p className="text-sm font-medium leading-none text-gray-800">Anita Jane</p>
                                    <p className="text-sm font-medium leading-none text-gray-600 mt-1 cursor-pointer hover:underline">Customer</p>
                                </div>
                            </div>
                        </div>
                    </div>
